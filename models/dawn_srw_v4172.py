"""
DAWN-SRW v4.1.7.2 standalone generalized-bilinear SRW implementation
...
class DAWN_SRW_V4172(nn.Module):
    """DAWN-SRW v4.1.7.2 with live generalized-bilinear RW keys."""
    ...
    def setup(self):
        ...
        if int(self.d_route) <= 0:
            raise ValueError(
                f"v4172 model.d_route must be > 0, got {self.d_route}")
