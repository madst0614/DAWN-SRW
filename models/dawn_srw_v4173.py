...
def symbolic_parameter_count(model_cfg):
    ...
    learned_keys = 0
    bilinear_probes = (d_route + d_model) * d_route
    counts = {
        ...
        'read_write_pools': operator_count * (d_route + d_model),
...
def _make_sharded_srw_production_diagnostics_minimal_impl(
    ...
    def production_core(
        ...
        initial_carry = (
            jnp.zeros(
                (batch_size, sequence_length, d_model), dtype=jnp.float32),
            jnp.zeros(
...
class DAWN_SRW_V4173(nn.Module):
    ...
    def get_model_info(self):
        ...
        return [
            ...
            f"  execution_write_width={self.d_model}",
            ...
            "Execution:",
            "  low-dimensional read / full-dimensional write",
            "  routes=Q,K,V,RST",
            "Composition:",
            *composition_info,
            ("  den_power["
