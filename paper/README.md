...
- `v12` is the active working draft. It is not tagged until release.
- Version numbers are repository metadata only; they are not printed on the
  paper's first page.

## Edit and build

Open `paper/v12/source/main.tex` in VS Code. With the recommended LaTeX
