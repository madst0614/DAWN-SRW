...
- Next experiment: run the published 40M config strictly from scratch on an explicitly named existing TPU. Do not resume any earlier v4175 checkpoint. First establish compile, HBM, finite step-1/short-window behavior, common-key gradients, and route-specific selection evidence.
