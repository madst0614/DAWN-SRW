...
- Publication state: `codex/v4167-poc` was fast-forwarded from `d478168f` through the accepted analytic-VJP tip `ee326ae0`; independent-basis and metric-contract implementation commit `fe3d82deb814675b1e7b27e60037727d67c29795` is published to `origin/codex/v4167-poc`.
