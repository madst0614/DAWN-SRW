...
| DAWN-SRW v4172 1.3B | `1,272,038,404` configured; restore verification pending | `19,999,981,568` in step-87,193 metadata | Committed step `87,193` frozen; restore and evaluation pending | Larger-scale performance and selected causal replication |
