...
- Current blocker: no IOI test blocker. The completed validation artifact is bound to clean analysis commit `209147bbbdaae00ebdf64655b917a91f77d50b26`, finalized canonical record commit `3b2f04aae3afe49fd1040c99e667acf50daadefc`, checkpoint step `76293`, mesh `16x2`, frozen-spec hash `6ec2661823bb52aa3bc336fb69fed1eef317f9cced02f836eaaade8c116a418c`, and result root ending `20260729T120132Z-ac1fc0cb`. Held-out plumbing is integrated at IOI-specific commit `bf45c76b`; the user explicitly authorized the existing TPU `spatial-se-400m`, and only that exact resource may be contacted.
- Next experiment: run only `ioi_frozen_test` on `spatial-se-400m` from one exact clean pushed POC commit. Open the test accessor for the first time, require exactly 128 canonical rows and 114 paired-correct independent units, and apply the unchanged 4,096 sites, full-denominator suppression, four control families times 100 with the same seeds/rules, frozen thresholds, and exact restoration. Finalize the result without any outcome-dependent change, including if negative.
