...
usage() {
    printf '%s\n' \
        ...
        "  --preset NAME              Item bundle: ioi_frozen_validation, ioi_native_program, ioi_paired_operator_trajectory, zero_shot, mechanistic_screen, circuit, causal, scientific, all" \
...
case "$PRESET" in
    contract|zero_shot|mechanistic_screen|ioi_frozen_validation|ioi_native_program|ioi_paired_operator_trajectory|mib_ioi_circuit|mib_mcqa_circuit|mib_arithmetic_circuit|mib_arc_circuit|circuit|ravel_causal|causal|scientific|all) ;;
