...
def create_train_step(model, optimizer, orth_weight, div_weight, lb_weight,
    ...
    def train_step(params, opt_state, input_ids, attention_mask, dropout_key):
        ...
        metrics = {
            ...
            'know_active_count': result.get('know_active_count', jnp.float32(0.0)),
            ...
            'attn_active_count': result.get('attn_active_count', jnp.float32(0.0)),
            ...
            if global_step % LOG_INTERVAL == 0 or _early_debug or debug_mode:
                if is_host0:
                    ...
                    try:
                        ...
                        k_gsum = _m(metrics.get('know_active_count', 0.0))
                        ...
                        a_gsum = _m(metrics.get('attn_active_count', 0.0))
