...
def build_model_from_config(cfg):
    ...
    if version == 'baseline':
        ...
        model = DAWN_SpatialV3(
            ...
            n_heads=mcfg.get('n_heads', 6),
            max_seq_len=mcfg.get('max_seq_len', 512),
            d_bottleneck=mcfg.get('d_bottleneck', 64),
            n_qk=mcfg.get('n_qk', 1700),
            n_v=mcfg.get('n_v', 2800),
            n_know=mcfg.get('n_know', 27200),
            max_k_qk=mcfg.get('max_k_qk', 170),
            max_k_v=mcfg.get('max_k_v', 280),
            max_k_know=mcfg.get('max_k_know', 1960),
            dropout_rate=mcfg.get('dropout', 0.1),
            router_dropout=mcfg.get('router_dropout', 0.1),
            gradient_checkpointing=mcfg.get('gradient_checkpointing', False),
        )
