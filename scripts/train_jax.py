...
def main():
    ...
    _sharded_fns = None
    if mesh_model > 1:
        _v3_mod = {'spatial-r1-v3.9.1': 'models.dawn_spatial_v3_baseline', 'spatial-r1-v3.9.3': 'models.dawn_spatial_v3_exp', 'spatial-r1-v3.9.4': 'models.dawn_spatial_v394_exp'}.get(model_version, 'models.dawn_spatial_v3')
